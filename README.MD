...
- `MaxConcurrentOneTimeJobs`: The maximum number of jobs that can run concurrently.
- `MaxConcurrentRecurringJobs`: The maximum number of jobs that can run concurrently.
